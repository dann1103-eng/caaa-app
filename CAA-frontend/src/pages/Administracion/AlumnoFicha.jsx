                ...
                <tbody>
                  {historial.vuelos.map(v => (
                    <tr key={v.id_vuelo}>
                      ...
                      <td>{v.aeronave_codigo || v.aeronave_modelo || "—"}{v.inasistencia && <span className="adf-tag amber" style={{ marginLeft: 6 }}>inasistencia</span>}{v.regreso_emergencia && <span className="adf-tag red" style={{ marginLeft: 6 }}>regreso anticipado</span>}</td>
