...
exports.publicarSemana = catchAsync(async (req, res) => {
  ...
  try {
    ...
    await client.query(`
      ...
      SELECT sv.id_detalle, sv.id_semana, ss.id_alumno, COALESCE(sv.id_instructor, al.id_instructor), sv.id_aeronave, sv.dia_semana, sv.id_bloque, sv.tipo_vuelo, sv.id_bloque_fin, 'PUBLICADO', 'ADMIN',
